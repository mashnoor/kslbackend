...
get_cse_home_data_api = Blueprint('get_cse_home_data_api', __name__)
url = "https://www.cse.com.bd"

@get_cse_home_data_api.route('/csehomedata/all_indexes')
def allIndexes():
    ...
    return json.dumps(all_idexes)


@get_cse_home_data_api.route('/csehomedata/market_summary')
def marketsummary():
    r = requests.get(url, verify=False)
    ...
    return json.dumps(market_summary_values)